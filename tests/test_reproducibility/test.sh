...
snakemake -s ../../Snakefile --configfile config.yaml --config result_dir=result0 --resources motif_lock=1 -p -j 2
snakemake -s ../../Snakefile --configfile config.yaml --config result_dir=result1 --resources motif_lock=1 -p -j 2
